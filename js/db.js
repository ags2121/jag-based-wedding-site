let db = [
	...
	},
	{
		...
		'data': [
			...
			'Dress code – seaside cocktail attire, nothing too fancy',
			'<br/>',
			'○○○',
			'<br/>',
	...
	},
	{
		...
		'data': [
			'<u>Getting There</u>',
			'The local airport is in Portland, Maine (PWM). If you fly to Boston, there’s a direct bus from Logan Airport to Portland on Concord Coach Lines.',
			'<br/>',
			'On the day of the wedding, guests coming from the mainland should take the <a target="_blank" class="link" href="https://www.cascobaylines.com/schedules/peaks-island-schedule/summer/">Casco Bay Lines Ferry</a> at 2:15 p.m. from Portland to Peaks Island.  The ferry ride is about 20 minutes, and a bus will take guests from the Peaks Island dock to the venue at 2:45 p.m.',
			'<br/>',
			'Ferries run every hour until 11:55 p.m., and the bus will take guests back to the dock at the end of the night.',
			'<br/>',
			'○○○',
			'<br/>',
			'<u>Accommodations</u>',
